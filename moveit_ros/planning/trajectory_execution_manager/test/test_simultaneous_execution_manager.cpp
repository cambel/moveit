...
TEST_F(MoveItCppTest, SimpleSimulatenousExecutionTest)
{
  ...
  bool res1 = moveit_cpp_ptr->getTrajectoryExecutionManager()->push(panda_1_robot_trajectory_msg);
  bool res2 = moveit_cpp_ptr->getTrajectoryExecutionManager()->push(panda_2_robot_trajectory_msg);
...
TEST_F(MoveItCppTest, MultipleSimulatenousExecutionTest)
{
  ...
  bool res1 = moveit_cpp_ptr->getTrajectoryExecutionManager()->push(panda_1_robot_trajectory_msg);
  bool res2 = moveit_cpp_ptr->getTrajectoryExecutionManager()->push(panda_2_robot_trajectory_msg);
  bool res3 = moveit_cpp_ptr->getTrajectoryExecutionManager()->push(panda_3_robot_trajectory_msg);
  bool res4 = moveit_cpp_ptr->getTrajectoryExecutionManager()->push(panda_4_robot_trajectory_msg);
